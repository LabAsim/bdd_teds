...
impute_items <- function(df,parallel=T, maxit=1, m=1,n.core=1){
  ...
  predMatrix["age_teach_14_1", c("sex_1", colnames(df_imp)[grepl(pattern="age",x=colnames(df_imp))])]
...
# imp <- impute_items(df=df_1,parallel=F, maxit=5, m=15)
s
